...
@RestController
@RequestMapping("/api/master-data-catalogue-ui-kafka")
public class MasterDataCatalogueUiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MasterDataCatalogueUiKafkaResource.class);
    ...
    public MasterDataCatalogueUiKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
